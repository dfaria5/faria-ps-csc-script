<#
	...
	@@@@@@@@@@@@@@@@@@@@@@@@@@
	 __  __ _       _                 _    _____ _                  
	|  \/  (_)     (_)               | |  / ____| |                 
	| \  / |_ _ __  _ _ __ ___   __ _| | | |    | | ___  __ _ _ __  
	| |\/| | | '_ \| | '_ ` _ \ / _` | | | |    | |/ _ \/ _` | '_ \ 
	| |  | | | | | | | | | | | | (_| | | | |____| |  __/ (_| | | | |
	|_|  |_|_|_| |_|_|_| |_| |_|\__,_|_|  \_____|_|\___|\__,_|_| |_|
#>
...
Write-Host "     @@@@@@@  @@@@@@@@@@@@@@@@@      __  __ _       _                 _    _____ _ 					" -ForegroundColor DarkBlue -BackgroundColor Black
Write-Host "    @@@@@@@@@  @@@@@@@@@@@@@@@      |  \/  (_)     (_)               | |  / ____| |					" -ForegroundColor DarkBlue -BackgroundColor Black
Write-Host "   @@@@@@@@  @@@@@@@@@@@@@@@@       | \  / |_ _ __  _ _ __ ___   __ _| | | |    | | ___  __ _ _ __  " -ForegroundColor DarkBlue -BackgroundColor Black
Write-Host "  @@@@@@@  @@@@@       @@@@@        | |\/| | | '_ \| | '_ ` _ \ / _` | | | |    | |/ _ \/ _` | '_ \ " -ForegroundColor DarkBlue -BackgroundColor Black
Write-Host " @@@@@@@@@@@@@@@@@@@@@@@@@@         | |  | | | | | | | | | | | | (_| | | | |____| |  __/ (_| | | | |" -ForegroundColor DarkBlue -BackgroundColor Black
Write-Host "@@@@@@@@@@@@@@@@@@@@@@@@@@          |_|  |_|_|_| |_|_|_| |_| |_|\__,_|_|  \_____|_|\___|\__,_|_| |_|" -ForegroundColor DarkBlue -BackgroundColor Black
